...
public class PictureUploadActivity extends BaseActivity {
    ...
    private void upload() {
        ...
        requestUserWorkParams.put("user_id", "22019101111285282639769");
        requestUserWorkParams.put("fileu_type", Izin_kerja);
        String sign = signParameter(requestUserWorkParams, "B1ECE9CC3BD5FB07974CFD03B1034242");
        requestUserWorkParams.put("sign", sign);

        //接口上传参数
        List<MultipartBody.Part> parts = new ArrayList<>();
        parts.add(toRequestBodyOfText("user_id","22019101111285282639769"));
                ...
                .subscribe(new Observer<BaseBean>() {
                    ...
                    public void onNext(BaseBean baseBean) {
                        ...
                        if (baseBean.getCode().equals("200")){
                            startActivity(new Intent(PictureUploadActivity.this,IdUploadActivity.class));
                        }
                    }
