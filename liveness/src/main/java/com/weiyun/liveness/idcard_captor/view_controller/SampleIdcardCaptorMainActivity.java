...
import com.weiyun.liveness.utils.IDCardStatus;
...
public class SampleIdcardCaptorMainActivity extends Activity implements CameraManager.CameraPreviewDataCallback, IDCardCaptureEventHandlerIf, CameraManager.CameraPictureCallback {
    ...
    private WyVerticalTextView mVerticalTextView;
...
//                                    ToastUtils.showShort(SampleIdcardCaptorMainActivity.this,
//                                            R.string.no_auto_to_take_picture);
                                    mVerticalTextView.setText(R.string.no_auto_to_take_picture);
                                    if (mCaptor != null) {
                                        mCaptor.uninit();
                                        mCaptor = null;
                                    }
...
//            actionBar.hide();
        ...
        mVerticalTextView = (WyVerticalTextView) findViewById(R.id.oliveapp_face_hintTextView);
